#pragma once
// AYShader/Ir.h - Phoskia Intermediate Representation (IR)
//
...
//
// Class layout follows AYShader\Ast.h: forward declarations first, then base
// classes, then concrete node classes, then accept() out-of-line.

#include "AYShader/Ast.h"   // PhoskiaSemantic, Token reused for IRBinaryExpr.op etc.
