#pragma once
// AYShader/BGFXConverter.h - BGFX backend converter (Phoskia → vs/fs/varying.def.sc)
//
...
#include "AYShader/ShadercDriver.h"  // Phase 3.6: _driver is a unique_ptr<AYShadercDriver>;
...
// `BGFXStorageBuffer`, `BGFXTexture`) moved to AYShader/ShaderProgram.h in
...
// "AYShader/ShaderProgram.h"` at the top of this header.
